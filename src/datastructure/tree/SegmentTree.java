...
public class SegmentTree<E> {
    ...
    public SegmentTree(E[] arr,Merger<E> merger){
        ...
        /*
        * 满二叉树的叶子节点要存放数组的所有元素需要 n 个空间，即最底层 h = n
        *
        * 由于二叉树的性质，最底层的叶子节点树约等于上层所有节点数只和，
        * 又有运算规则 h(h层节点数) = 2^h -1，即一个满二叉树的节点数为 2n = h + (h-1)
        *
        * 线段树不是满二叉树，底层节点不填满，因此需要再加一层，即为 4n
        *
        * 线段树为平衡二叉树 - 最大深度和最小深度之差的绝对值为 1.
        * */
